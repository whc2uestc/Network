...
#define TXT_WHO 2
#define TXT_ERROR 3
#define TXT_JOIN_S2S 10
#define TXT_LEAVE_S2S 11
#define TXT_SAY_S2S 12
...
typedef struct text_join_s2s {
        text_t txt_type; /* =  */
        char channelname[USERNAME_MAX];
}text_join_s2s;
typedef struct text_leave_s2s {
        text_t txt_type; /* =  */
        char channelname[USERNAME_MAX];
}text_leave_s2s;
typedef struct text_say_s2s {
        text_t txt_type; /* =  */
		long long txt_idenf;
		char txt_username[USERNAME_MAX];
		char txt_channel[CHANNEL_MAX];
